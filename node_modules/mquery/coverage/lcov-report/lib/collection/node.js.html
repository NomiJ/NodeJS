...
<html lang="en">
<head>
    <title>Code coverage report for lib/collection/node.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/collection/node.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/collection/</a> &#187; node.js</div>
</div>
<div class="body">
...
NodeCollection.prototype.findAndModify = function (match, update, options, cb) {
  var sort = Array.isArray(options.sort) ? <span class="branch-0 cbranch-no" title="branch not covered" >options.sort </span>: [];
